            ...
            <div className="bg-zinc-900 rounded-xl p-6 border border-zinc-800">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-medium text-zinc-400">Service Provider Profile</h4>
                    <p className="text-xs text-zinc-500 mt-1">Update your service provider details</p>
                  </div>
                  <Button
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-medium text-zinc-400">ID Verification</h4>
                    <p className="text-xs text-zinc-500 mt-1">Verify your identity for better trust</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-medium text-zinc-400">Skills & Tools</h4>
                    <p className="text-xs text-zinc-500 mt-1">Manage your skills and tools</p>
                  </div>
                  <Button
              ...
              <div className="space-y-4">
                ...
                <div className="border-t border-zinc-800 pt-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-zinc-400">Job alerts</span>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-zinc-400">Client messages</span>
                      <Switch
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-zinc-500 mt-1">Make your profile visible to clients</p>
                  </div>
          ...
          <TabsContent value="billing" className="space-y-6">
            ...
            <div className="bg-zinc-900 rounded-xl p-6 border border-zinc-800">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-medium text-zinc-400">Payout Method</h4>
                    <p className="text-xs text-zinc-500 mt-1">Bank Account</p>
                  </div>
                  <Button variant="outline" className="border-zinc-700 text-zinc-400 hover:bg-zinc-800">
                    Change
                  </Button>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-medium text-zinc-400">Minimum Payout</h4>
                    <p className="text-xs text-zinc-500 mt-1">$50</p>
                  </div>
                  <Button variant="outline" className="border-zinc-700 text-zinc-400 hover:bg-zinc-800">
                    Change
                  </Button>
