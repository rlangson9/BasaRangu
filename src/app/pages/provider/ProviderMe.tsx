...
export function ProviderMe() {
  ...
  const menuItems = [
    { icon: FileUser, label: "My Resume", path: "/provider/resume" },
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-6">
        <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800 mb-6">
          ...
          <div className="mt-4 bg-gradient-to-r from-teal-600 to-teal-700 rounded-xl p-4 flex items-center justify-between">
            <div>
              <h3 className="text-white font-semibold text-lg">Want more jobs?</h3>
              <p className="text-teal-100 text-xs mt-1">Upgrade to Premium for higher job visibility and priority listings</p>
            </div>
