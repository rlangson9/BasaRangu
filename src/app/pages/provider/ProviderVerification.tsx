...
export function ProviderVerification() {
  ...
  const handleBusinessUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    // In a real app, this would upload the image
    // For now, just show a toast
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-zinc-700 rounded-lg p-6 text-center">
                    <Camera className="w-12 h-12 text-zinc-500 mx-auto mb-2" />
                    <p className="text-sm text-zinc-400 mb-4">
                      Upload a clear photo of your business license (if applicable)
                    </p>
                    <label className="inline-block">
                      <Input
                        type="file"
          ...
          <div className="bg-zinc-900 rounded-xl p-6 border border-zinc-800">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-zinc-400">
                As a verified service provider, you'll enjoy increased trust from clients and access to premium features.
              </p>
            </div>
          </div>
        )}
