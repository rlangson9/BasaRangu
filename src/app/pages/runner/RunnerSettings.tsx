            ...
            <div className="bg-zinc-900 rounded-xl p-6 border border-zinc-800">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="text-sm font-medium text-zinc-400">Errand Runner Profile</h4>
                    <p className="text-xs text-zinc-500 mt-1">Update your errand runner details</p>
                  </div>
                  <Button
              ...
              <div className="space-y-4">
                ...
                <div className="border-t border-zinc-800 pt-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-zinc-400">Errand alerts</span>
                      <Switch
                        checked={notifications.errandAlerts}
                        onCheckedChange={(checked) => setNotifications({ ...notifications, errandAlerts: checked })}
                      />
                    </div>
                    <div className="flex items-center justify-between">
