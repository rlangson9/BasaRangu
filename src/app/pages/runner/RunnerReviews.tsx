      ...
      const mockReviews: Review[] = [
        {
          ...
          userAvatar: "",
          rating: 5,
          comment: "John was punctual and delivered my groceries quickly. He even helped carry them to my door!",
          date: "2024-03-15T10:30:00Z",
          status: "completed",
          response: "Thank you for your kind words! I'm glad I could help with your groceries.",
          errandType: "Grocery Delivery"
        },
        {
          id: "2",
          userName: "Bob Smith",
          userAvatar: "",
          rating: 4,
          comment: "Good document pickup service. Jane was friendly, though she arrived a bit late.",
          date: "2024-03-10T14:20:00Z",
          status: "completed",
          errandType: "Document Pickup"
        },
        {
          id: "3",
          ...
          userAvatar: "",
          rating: 5,
          comment: "Mike did an amazing job with my package delivery. He was fast and communicated well.",
        ...
        },
        {
          ...
          userAvatar: "",
          rating: 3,
          comment: "The errand was completed, but the runner forgot one item on my list.",
                    ...
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <Badge className="bg-zinc-800 text-zinc-400">{review.errandType}</Badge>
                        </div>
